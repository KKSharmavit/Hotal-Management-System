...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        add_cust=Button(btn_frame,text="ADDING",bd=0,relief=RIDGE,width=22,command=self.details_add,font=("times new roman",14,"bold"),bg="black",fg="gold",cursor="hand2")
        add_cust.grid(row=2,column=0,pady=1)

        add_cust=Button(btn_frame,text="REPORT",bd=0,relief=RIDGE,width=22,command=self.Info_details,font=("times new roman",14,"bold"),bg="black",fg="gold",cursor="hand2")
